...
public class Woman extends Human<Pomade> {

    public Woman(String newName, String newSurName) {
    ...
    public String addHumanObject() {
        ...
        String n = Human.paramString("Создание Помады : \n Введите имя ...");
        ...
        this.getHumanObjects().add(new Pomade(n,color,i));
        System.out.println("Создана новая помада");
    ...
    protected void setHumanObject_() {
        try {
            ...
            do{
                bool = false;
                switch (Human.paramInteger("Выберете параметр для изменения помады:" +
    ...
    public String toString() {
        return "Женщина " + getName() +" " + getSurname() + "\n" + super.toString() ;
    }
